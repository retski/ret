...
import os, json, discord, yt_dlp, re, ffmpeg, traceback, logging, sys, asyncio, json
...
async def on_command(message):
    if message.author == bot.user:
        return
    banned = [969117255965229086, 329400132325867530]
    if message.author.id in banned:
        await message.channel.send(f'{message.author.mention} fk off')
        return
